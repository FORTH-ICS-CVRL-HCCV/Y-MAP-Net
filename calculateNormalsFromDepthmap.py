...
def improve_depthmap(depthmap_int8, normalX_int8, normalY_int8, normalZ_int8, learning_rate, iterations,
                     depth_threshold=20):
...
def integrate_normals(normalX_int8, normalY_int8, normalZ_int8, initial_depth=None, iterations=500):
    ...
    for _ in range(iterations):
        ...
        # Average updates
        depth_update = (np.roll(depth_x, 1, axis=1) + depth_x + np.roll(depth_y, 1, axis=0) + depth_y) / 4
